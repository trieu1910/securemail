...
export function PasswordLock({ password, confirm, onPasswordChange, onConfirmChange }: Props) {
  ...
  return (
    <div className="space-y-3">
      <div>
        <label className="mb-1 block text-sm font-medium text-gmail-text dark:text-gray-100">Password</label>
        <div className="relative">
          <input
            ...
            className="w-full rounded-lg border border-gmail-border dark:border-gray-600 px-3 py-2 pr-10 text-sm text-gmail-text dark:text-gray-100 bg-white dark:bg-gray-700 outline-none focus:ring-2 focus:ring-gmail-blue/20 focus:border-gmail-blue transition-all"
          />
        ...
        {password.length > 0 && (
          <div className="mt-1.5">
            ...
            <p className="mt-0.5 text-xs text-gmail-text-secondary dark:text-gray-400">{strength.label}</p>
          </div>
        )}
      </div>
      <div>
        <label className="mb-1 block text-sm font-medium text-gmail-text dark:text-gray-100">Confirm Password</label>
        <input
          type="password"
          value={confirm}
          ...
          className={`w-full rounded-lg border px-3 py-2 text-sm text-gmail-text dark:text-gray-100 bg-white dark:bg-gray-700 outline-none focus:ring-2 focus:ring-gmail-blue/20 focus:border-gmail-blue transition-all ${mismatch ? 'border-gmail-red' : 'border-gmail-border dark:border-gray-600'}`}
        />
